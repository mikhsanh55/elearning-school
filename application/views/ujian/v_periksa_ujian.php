...
<nav class="navbar navbar-findcond navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand"><i class="fa fa-globe"></i> Hasil Ulangan</a>
        </div>
    </div>
</nav>
    ...
    <div class="col-md-3" id="v_jawaban">
        <div class="panel panel-default">
            <div class="panel-heading" style="overflow: auto;">
                <div class="btn btn-default col-md-12">Data Siswa</div>
            </div>
            <div class="panel-body container" style="overflow: auto;padding: 10px">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="overflow: auto">
                    <?php $i = 0;foreach($soal as $data) : 
                        $arrayUserAnswer = explode(':', $jawaban_user[$i]);
                        $idSoal = $arrayUserAnswer[0];
                        $userAnswer = $arrayUserAnswer[1];

                        $arrayCorrectAnswer = explode(':', $jawaban_benar[$i]);
                        $correctAnswer = $arrayCorrectAnswer[1];
                        ...
                        foreach($allOptions as $key => $option) {
                            ...
                            if($userAnswer == $correctAnswer && strtoupper($key) == $userAnswer) {
                                $allOptions[$key]['class'] = 'btn-success';
                            }
                            else if($userAnswer != $correctAnswer && strtoupper($key) == $userAnswer) {
                                $allOptions[$key]['class'] = 'btn-danger';
                            }
                            else if(strtoupper($key) == $correctAnswer) {
                                $allOptions[$key]['class'] = 'btn-success';
                            }
                            else {
...
<script>
    $(document).ready(function() {
        let activeWidget = '#widget_', activeSoal = 1, sumSoal = "<?= count($soal); ?>";
