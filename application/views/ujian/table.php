...
<table class="table table-bordered table-striped table-hovered">
	<thead>
		...
		<?php $i= $page_start; foreach ($paginate['data'] as $rows):
			...
			$cekHasilEssay = $this->m_ikut_ujian->count_by(['id_ujian'=>$rows->id,'status'=>'N']);
