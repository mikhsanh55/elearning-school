		...
		?>
			<tr>
				...
				<div class="btn-group d-flex justify-content-center">
					<a class="btn btn-success btn-sm hit-btn mr-2" href="<?=base_url('materi/lists/').md5($rows->id_mapel);?>"><i class="glyphicon glyphicon-eye" style="margin-left: 0px; color: #fff"></i> &nbsp;&nbsp;Materi</a>
