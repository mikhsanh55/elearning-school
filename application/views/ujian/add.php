	...
	<div class="inner-box">
		...
		<form id="form" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="nama_ujian" placeholder="Masukan Nama Ujian" name="nama_ujian" required="">
			...
			<div class="row">
				...
				<div class="col-md-6 form-group">
					...
					<input type="text" value="" class="form-control only-number"  id="min_nilai" placeholder="Angka" name="min_nilai" required="" minlength="2">
	...
	$(document).on('submit','#form',function(event){
		...
		if (error == 0) {
			...
			$.ajax({
				...
				url  : '<?=base_url('ujian_real/insert');?>',
