  ...
  <div class="panel panel-info">
    <div class="panel-heading">Daftar Hasil Tes
     <div class="tombol-kanan">
        <a href='<?php echo base_url(); ?>hasil/hasil_ujian_cetak/<?php echo $uri4; ?>' class='btn btn-info btn-sm d-none' target='_blank'><i class='glyphicon glyphicon-print'></i> Cetak</a>
      </div>
    </div>
