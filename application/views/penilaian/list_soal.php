						...
						<div class="panel-heading">
							<div class="tombol-kanan">
								<div class="row">
									...
									<button class="btn btn-light text-right" onclick="back_page('penilaian/paket_soal')">Kembali</button>
						            </div>
						        </div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php if ($this->log_lvl != 'siswa'): ?>
					...
					<a class="btn btn-warning btn-sm tombol-kanan" href="<?php echo base_url(); ?>upload/format_soal_penilaian.xlsx" ><i class="glyphicon glyphicon-download"></i> &nbsp;&nbsp;Download Format Import</a>

					 <a class="btn btn-info btn-sm tombol-kanan" href="<?= base_url('penilaian/import-soal/' . encrypt_url($id_paket));?>" ><i class="glyphicon glyphicon-upload"></i> &nbsp;&nbsp;Import Excel</a>
