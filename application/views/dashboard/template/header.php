...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <!-- Fav and touch icons -->
      <link rel="icon" sizes="144x144" href="<?= base_url(); ?>assets/ico/apple-touch-icon-144-precomposed.png">
      <link rel="icon" sizes="114x114" href="<?= base_url(); ?>assets/ico/apple-touch-icon-114-precomposed.png">
      <link rel="icon" sizes="72x72" href="<?= base_url(); ?>assets/ico/apple-touch-icon-72-precomposed.png">
      <link rel="icon" href="<?= base_url(); ?>assets/ico/apple-touch-icon-57-precomposed.png">
      ...
      <!-- Data Tables CSS -->
      <link rel="stylesheet" href="<?= base_url('assets/plugin/datatables/jquery.dataTables.min.css') ?>">
