					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<div class="tombol-kanan">
								<h2><strong>Data Instansi</strong></h2>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php if ($this->log_lvl == 'admin'): ?>
					<a class="btn btn-primary btn-sm" style="background-color: #337ab7" href="<?=base_url('instansi/add');?>"><i class="glyphicon glyphicon-plus"></i> &nbsp;&nbsp;Tambah</a>
				<?php endif;?>
