				...
				<div class="col-md-12">
							...
							<div class="tombol-kanan">
								<div class="row">
						            <div class="col-sm-12 col-md-6 col-lg-6">
						                <h2>Aktivasi Materi untuk Instansi <strong><?=$instansi->instansi;?></strong></h2>
						            </div>
					...
					<from class="form-inline" style="display: block;">
						<div class="form-group">
							...
							<select id="trainer" class="form-control input-sm">
								<option value="">Pilih Trainer</option>
								<?php foreach ($trainer as $rows): ?>
...
<script type="text/javascript">
	$(document).ready(function(){
		pageLoad(1,'instansi/pageload_materi');
