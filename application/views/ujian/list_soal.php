		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php if ($this->log_lvl != 'siswa'): ?>
					...
					<a class="btn btn-warning btn-sm tombol-kanan" href="<?php echo base_url(); ?>upload/format_soal_ujian.xlsx" ><i class="glyphicon glyphicon-download"></i> &nbsp;&nbsp;Download Format Import</a>
