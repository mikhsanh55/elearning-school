<div class="row col-md-12 ini_bodi">
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      ...
      <input type="hidden" name="penggunaan" id="penggunaan" value="<?php echo $du['penggunaan']; ?>">
      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-body">
            <table class="table table-responsive table-bordered" style="width:100%; padding:10px;">
              <tr><td width="35%">Nama</td><td width="65%"><?php echo $dp['nama']; ?></td></tr>
              <tr><td>Modul</td><td><?php echo $du['nmmapel']; ?></td></tr>
              <tr><td>Trainer</td><td><?php echo $du['nmguru']; ?></td></tr>
