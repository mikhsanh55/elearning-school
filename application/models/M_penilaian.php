...
class M_penilaian extends MY_Model {
    ...
    public function get_output1($where=array(), $limit = 5){
        $get = $this->db->select('
                            (SELECT gur.nama FROM m_guru gur WHERE gur.id = kls.id_trainer) as nama_guru,
	 ...
	 public function paginate($page = 1, $where = array(), $limit = 10)
    {
	 ...
	 public function out1($page = 1, $where = array(), $limit = 10)
     {
        ...
        $results = $this->get_output1($where, $limit);
     ...
     public function out2($page = 1, $where = array(), $limit)
     {
         $penilaian = $this->get_output1($where, $limit);
         if(empty($penilaian)){
            echo 'Belum ada penilaian';
            exit;
        }
